...
types_iris = dict(zip( [0,1,2], target_names))
#%%

name_atributos = ['sepal length (cm)', 'sepal width (cm)', 'petal length (cm)', 'petal width (cm)']
...
sns.histplot(data = data, x = name_atributos[0], hue = 'target', bins = nbins, stat = 'probability', ax=s[0,0], palette = 'viridis')

sns.histplot(data = data, x = name_atributos[1], hue = 'target', bins = nbins, stat = 'probability', ax=s[0,1], palette = 'viridis')

sns.histplot(data = data, x = name_atributos[2], hue = 'target', bins = nbins, stat = 'probability', ax=s[1,0], palette = 'viridis')

sns.histplot(data = data, x = name_atributos[3], hue = 'target', bins = nbins, stat = 'probability', ax=s[1,1], palette = 'viridis')
